    ...
    <footer className="footer">
      ...
      <div className="footer-links">
        <div className="footer-link-group">
          <h4>BOOK YOUR CALENDER</h4>
          <p>
            Theatre happening Today | Theatre happening Tomorrow | Theatre
            happening This Weekend
          </p>
        </div>
        <div className="footer-link-group">
          <h4>PLAYS IN JAIPUR</h4>
          <p>
            Theatre | Experimental | Improv Theatre | Interactive Theatre | Mime
            | Monologue | Non-verbal | Puppetry | Storytelling | Street Plays
          </p>
        </div>
        <div className="footer-link-group">
          <h4>HELP</h4>
      ...
      <div className="footer-bottom">
       <img src="logo-no-background.png" alt="" />
        ...
        <div className="copyright">
            <p>Copyright 2024 BookYourShow. All rights reserved.</p>
